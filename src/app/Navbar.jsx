  ...
  return (
    <>
      <div className='bg-[#2d2e2e] fixed left-0 right-0 z-40 shadow-xl text-white px-8 py-4 font-semibold text-2xl flex items-center justify-between  md:justify-around '>
        <Link href={'/'} className="z-40"><h1 className='cursor-pointer text-3xl'>SB</h1></Link>
        ...
        {
            navbar ? <AiOutlineClose size={30} className='z-40 cursor-pointer'/> : 
            <GiHamburgerMenu size={30} className='z-40 cursor-pointer'/>
        }
        </div>
        <div className={navbar ? 'fixed top-0 right-0 ease-in-out duration-700 w-[100%] h-[100%] bg-[#000] flex justify-center items-center text-4xl' : 'fixed top-[-100%]'}>
